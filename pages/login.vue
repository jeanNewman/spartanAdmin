            ...
            <v-card class="elevation-1 pa-3">
              <v-card-text>
                <div class="layout column align-center">
                  <img class="imgRedonda" src="../static/logospartan.png" alt="Vue Material Admin" width="150" height="150">
                  <h2 class="flex my-4 primary--text">Spartan Admin Login</h2>
                </div>
                <v-form>
...
<style scoped lang="css">
  ...
  .primary {
    background: linear-gradient(180deg, rgba(242,134,8,1) 17%, rgba(228,103,71,1) 57%);
    border-color: #e46747 !important;
  }
  .imgRedonda {
    width:200px;
    height:200px;
